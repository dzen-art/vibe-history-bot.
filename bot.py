...
try:
    ...
    prompt = f"Расскажи один исторический факт. Напиши его кратко. Затем напиши слово 'Квиз' и задай один вопрос по этому факту. Первым вариантом ответа всегда пиши правильный: {event}"
