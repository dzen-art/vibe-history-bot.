...
try:
    ...
    prompt = f"Напиши один короткий и шокирующий исторический факт на сегодня. Сразу после него напиши слово 'Квиз' и один вопрос с 3 вариантами ответа, где первый — правильный. ЗАПРЕЩЕНО: писать вступления, пояснения, пункты и свои мысли. Только факт и квиз: {event}"
